...
async function createPatients() {
  ...
  await Promise.all([
    ...
    patientCreate(2, "Emily", "Smith", "1985-09-15", "No patient history", 02012345, "asthma"),
    ...
    patientCreate(7, "Ethan", "Garcia", "1989-10-10", "No patient history", 07012345, false),
    patientCreate(8, "Olivia", "Martinez", "1965-08-03", false, 08012345, "arthritis"),
    patientCreate(9, "Aiden", "Lopez", "1970-04-12", "No patient history", 09012345, false),
    ...
    patientCreate(12, "Mia", "Jackson", "1980-05-19", "No patient history", 12012345, "asthma"),
    patientCreate(13, "James", "Gonzalez", "1968-09-08", "No patient history", 13012345, false),
    ...
    patientCreate(17, "Lucas", "Martin", "1983-01-02", "No patient history", 17012345, false),
    ...
    patientCreate(23, "Alexander", "Hill", "1967-09-21", "Not available", 23012345, false),
    ...
    patientCreate(26, "Sofia", "King", "1960-11-24", "Not Available", 26012345, "hypertension"),
    patientCreate(27, "Matthew", "Adams", "1976-01-15", "Not available", 27012345, false),
    ...
    patientCreate(36, "Grace", "Sanchez", "1975-02-14", "Not Available", 36012345, "hypertension"),
    patientCreate(37, "Ella", "Mitchell", "1991-10-08", "Not available", 37012345, false),
    ...
    patientCreate(43, "Nathan", "Gutierrez", "1976-09-11", "Not available", 43012345, false),
    ...
    patientCreate(47, "Zoe", "Washington", "1984-12-18", "Not available", 47012345, false),
    ...
    patientCreate(53, "Lillian", "Reed", "1992-09-08", "Not available", 53012345, false),
    ...
    patientCreate(57, "Nora", "Coleman", "1987-11-08", "Not available", 57012345, false),
    ...
    patientCreate(62, "Hunter", "Ward", "1996-05-19", "Not Available", 62012345, "asthma"),
    patientCreate(63, "Hazel", "Gutierrez", "1977-09-11", "Not available", 63012345, false),
    ...
    patientCreate(66, "Violet", "Ward", "1978-01-16", "Not Available", 66012345, "hypertension"),
    patientCreate(67, "Sawyer", "Washington", "1984-12-18", "Not available", 67012345, false),
    ...
    patientCreate(73, "Mila", "Reed", "1992-09-08", "Not available", 73012345, false),
    ...
    patientCreate(77, "Aurora", "Coleman", "1987-11-08", "Not available", 77012345, false),
    patientCreate(78, "Owen", "Bryant", "1973-04-22", false, 78012345, "arthritis"),
    patientCreate(79, "Levi", "Nguyen", "1980-06-03", "Not Available", 79012345, false),
    ...
    patientCreate(82, "Julian", "Ward", "1996-05-19", "Not Available", 82012345, "asthma"),
    patientCreate(83, "Amara", "Gutierrez", "1977-09-11", "Not available", 83012345, false),
    patientCreate(84, "Aaron", "Hill", "1983-03-04", false, 84012345, "diabetes"),
    patientCreate(85, "Ivy", "Ross", "1962-07-25", false, 85012345, false),
    patientCreate(86, "Ezra", "Ward", "1978-01-16", "Not Available", 86012345, "hypertension"),
    patientCreate(87, "Alice", "Washington", "1984-12-18", "Not available", 87012345, false),
    patientCreate(88, "Wyatt", "Price", "1970-08-27", false, 88012345, "arthritis"),
    patientCreate(89, "Elena", "Butler", "1986-04-07", "Not Available", 89012345, false),
    ...
    patientCreate(93, "Ariana", "Reed", "1992-09-08", "Not available", 93012345, false),
    ...
    patientCreate(97, "Sienna", "Coleman", "1987-11-08", "Not available", 97012345, false),

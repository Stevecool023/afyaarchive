...
async function createPatientHistories() {
  ...
  await Promise.all([
    patientHistoryCreate(0, "2023-08-20", "Under Medication", "2023-08-20", "2023-10-15", hospitals[5].name, ["Hypertension"], ["Lisinopril", "Amlodipine"]),
    patientHistoryCreate(1, "2023-05-12", "Under Medication", "2023-05-12", "2023-08-30", hospitals[12].name, ["Type 2 Diabetes"], ["Metformin", "Gliclazide"]),
    patientHistoryCreate(2, "2023-09-28", "Under Medication", "2023-09-28", "2024-01-15", hospitals[18].name, ["Asthma"], ["Salbutamol", "Fluticasone"]),
    patientHistoryCreate(3, "2023-11-05", "Under Medication", "2023-11-05", "2024-02-20", hospitals[25].name, ["Rheumatoid Arthritis"], ["Methotrexate", "Prednisone"]),
    patientHistoryCreate(4, "2023-07-10", "Under Medication", "2023-07-10", "2023-10-25", hospitals[8].name, ["Depression", "Anxiety"], ["Sertraline", "Lorazepam"]),
    patientHistoryCreate(5, "2023-06-15", false, null, null, hospitals[14].name, ["Migraine"], ["Sumatriptan"]),
    patientHistoryCreate(6, "2023-10-02", "Under Medication", "2023-10-02", "2024-01-10", hospitals[28].name, ["Chronic Kidney Disease"], ["Furosemide", "Losartan"]),
    patientHistoryCreate(7, "2023-08-18", false, null, null, hospitals[3].name, ["Asthma"], ["Albuterol"]),
    patientHistoryCreate(8, "2023-11-30", "Under Medication", "2023-11-30", "2024-03-05", hospitals[19].name, ["Osteoarthritis"], ["Ibuprofen", "Acetaminophen"]),
    patientHistoryCreate(9, "2023-09-10", "Under Medication", "2023-09-10", "2024-01-15", hospitals[22].name, ["Hyperthyroidism"], ["Propylthiouracil", "Propranolol"]),
    patientHistoryCreate(10, "2023-12-25", false, null, null, hospitals[7].name, ["Hypertension"], ["Atenolol"]),
    patientHistoryCreate(11, "2023-10-15", false, null, null, hospitals[17].name, ["Type 1 Diabetes"], ["Insulin"]),
    patientHistoryCreate(12, "2023-07-05", "Under Medication", "2023-07-05", "2023-10-20", hospitals[11].name, ["Chronic Obstructive Pulmonary Disease"], ["Salmeterol", "Fluticasone"]),
    patientHistoryCreate(13, "2023-05-20", false, null, null, hospitals[29].name, ["Gastroesophageal Reflux Disease"], ["Omeprazole"]),
    patientHistoryCreate(14, "2023-09-08", "Under Medication", "2023-09-08", "2024-01-05", hospitals[2].name, ["Epilepsy"], ["Levetiracetam", "Lamotrigine"]),
    patientHistoryCreate(15, "2023-08-30", false, null, null, hospitals[9].name, ["Chronic Kidney Disease"], ["Vitamin D"]),
    patientHistoryCreate(16, "2023-11-18", "Under Medication", "2023-11-18", "2024-02-25", hospitals[26].name, ["Hypothyroidism"], ["Levothyroxine"]),
    patientHistoryCreate(17, "2023-10-02", false, null, null, hospitals[21].name, ["Rheumatoid Arthritis"], ["Hydroxychloroquine"]),
    patientHistoryCreate(18, "2023-07-15", "Under Medication", "2023-07-15", "2023-10-30", hospitals[33].name, ["Atrial Fibrillation"], ["Warfarin"]),
    patientHistoryCreate(19, "2023-06-20", false, null, null, hospitals[10].name, ["Migraine"], ["Propranolol"]),
    patientHistoryCreate(20, "2023-09-28", "Under Medication", "2023-09-28", "2024-01-15", hospitals[16].name, ["Asthma"], ["Budesonide", "Formoterol"]),
    patientHistoryCreate(21, "2023-08-12", false, null, null, hospitals[20].name, ["Osteoarthritis"], ["Naproxen"]),
    patientHistoryCreate(22, "2023-11-05", "Under Medication", "2023-11-05", "2024-02-20", hospitals[24].name, ["Major Depressive Disorder"], ["Escitalopram"]),
    patientHistoryCreate(23, "2023-07-10", false, null, null, hospitals[6].name, ["Chronic Obstructive Pulmonary Disease"], ["Tiotropium"]),
    patientHistoryCreate(24, "2023-06-15", "Under Medication", "2023-06-15", "2023-09-30", hospitals[27].name, ["Gastroesophageal Reflux Disease"], ["Ranitidine"]),
    patientHistoryCreate(25, "2023-10-02", false, null, null, hospitals[31].name, ["Type 2 Diabetes"], ["Sitagliptin", "Metformin"]),
    patientHistoryCreate(26, "2023-08-18", "Under Medication", "2023-08-18", "2023-12-25", hospitals[30].name, ["Atrial Fibrillation"], ["Dabigatran"]),
    patientHistoryCreate(27, "2023-11-30", false, null, null, hospitals[15].name, ["Hypothyroidism"], ["Liothyronine"]),
    patientHistoryCreate(28, "2023-09-10", "Under Medication", "2023-09-10", "2024-01-15", hospitals[23].name, ["Epilepsy"], ["Phenytoin", "Valproic Acid"]),
    patientHistoryCreate(29, "2023-12-25", false, null, null, hospitals[13].name, ["Hypertension"], ["Losartan"]),
